...
comptime GITHUB_REPO_URL = "https://github.com/ratulb/mojo_programming/blob/main/codes/"
comptime CODES_DIR = Path("codes")
comptime DOCS_DIR = Path("../docs")
comptime INDEX_MD = DOCS_DIR / "index.md"
